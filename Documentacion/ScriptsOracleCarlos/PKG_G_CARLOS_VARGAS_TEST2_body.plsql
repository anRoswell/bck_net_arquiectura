              ...
              JSON_OBJECT (
                ...
                'traza' VALUE JSON_ARRAYAGG (
                  JSON_OBJECT (
                    ...
                    'nombre_estado_orden' VALUE NVL(eo.Descripcion,-1),
                    'id_contratista' VALUE NVL(a.id_contratista,-1),
                    'nombre_contratista' VALUE NVL(c.Nombre_Completo,'-'),            
                    'id_contratista_persona' VALUE NVL(a.id_contratista_persona,-1),
                    'nombre_contratista_persona' VALUE NVL(d.Nombre_Contratista_persona,'-'),            
