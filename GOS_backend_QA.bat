...
:: BUILD
@echo Ejecutando docker build --build-arg AppEnv=QA -t backop360qagos .
docker build --build-arg AppEnv=QA -t backop360qagos .

:: CHANGE NAME
color 0A &:: Verde sobre fondo negro
@echo CHANGE TAG
docker image tag backop360qagos 73197546/backop360qagos:1.0.1
color 0E &:: Amarillo sobre fondo negro
@echo Cambio de Tag finalizado

:: PUSH
color 0B &:: Cyan sobre fondo negro
@echo Ejecutando docker push 73197546/backop360qagos:1.0.1
docker push 73197546/backop360qagos:1.0.1
