...
namespace Core.DTOs
{
    public class RequerimientoAdjudicacionDto
    {
        ...
        public List<ReqCriterosEvaluacion> EvaluacionCriterios { get; set; }
        public List<UsuarioDto> Gestores { get; set; }
        public List<AdjudicacionReq> Adjudicacion { get; set; }
        public List<AdjudicacionOrdenes> AdjudicacionOrdenes { get; set; }
        public List<ParticipantesReqAdjudicacion> Participantes { get; set; }
    }
}
