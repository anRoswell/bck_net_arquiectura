...
namespace Core.DTOs
{
    public class ParticipacionDataReporteDto
    {
        ...
        public List<ArticulosOfrecidosParticipanteReq> ArticulosOfrecidos { get; set; }
        public List<ReqParticipantes> Participante { get; set; }
    }
}
