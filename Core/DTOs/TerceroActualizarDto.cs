...
public partial class TerceroActualizarDto
{
    ...
    public List<PrvSocio> PrvSocios { get; set; }
    public List<PrvReferencia> PrvReferencias { get; set; }
    public List<int> ListEmpresas { get; set; }
    public List<int> ListProdServicios { get; set; }
    public List<ParametrosGestionProveedor> ParametrosGestionProveedor { get; set; }
