...
{
    public class gnl_peticiones_corsConfiguration : IEntityTypeConfiguration<gnl_peticiones_cors>
    {
        public void Configure(EntityTypeBuilder<gnl_peticiones_cors> builder)
        {
            builder.ToTable("GNL_PETICIONES_CORS", "AIRE");

            builder.HasKey(e => e.Id);
            builder.Property(e => e.Id).HasColumnName("ID_PETICION_CORS");

            var properties = typeof(gnl_peticiones_cors).GetProperties().Where(x => x.Name != "Id");
