...
namespace Infrastructure.Data.Configurations
{
    public class TipoUsuarioConfiguration : IEntityTypeConfiguration<TipoUsuario>
    {
        ...
        {
            builder.ToTable("TipoUsuario", "usr");

            builder.HasKey(e => e.Id)
                .HasName("PK__TipoUsua__36E0B757D3C959BF");

            builder.Property(e => e.Id)
                .HasColumnName("Tusr_IdTipoUsuario")
                .HasComment("");
            ...
            builder.Property(e => e.TusrDescripcion)
                .IsRequired()
                .HasMaxLength(30)
                .IsUnicode(false)
                .HasColumnName("Tusr_Descripcion")
                .HasDefaultValueSql("((0))")
                .HasComment("Descripcion del tipo de usuario");

            builder.Property(e => e.TusrEstado)
                .IsRequired()
                .HasColumnName("Tusr_Estado")
